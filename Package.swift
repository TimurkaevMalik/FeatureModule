...
#warning("Change type     if needed")
#warning("Change name     if needed")
#warning("Change platform if needed")

let featureName = "FeatureModule"
...
let package = Package(
    ...
    dependencies: [/*.make(from: SPMDependency.coreKit),*/],
    targets: [
        .target(
            name: featureName,
